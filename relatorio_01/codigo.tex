...
\section{A equação de Poisson em uma malha estruturada}
...
\begin{equation}
  \label{eq:sistema_01}
   ...
   \right] 
\end{equation}
em que $a=2/h_x^2+2/h_y^2 = 26$, $b= -1/h_x^2=-9$ e $c = -1/h_y^2=-4$. A matriz $A$ não é simétrica e seu número de condição na norma 2 é $k(A)=||A||_2||A^{-1}||_2=43.16$. 
