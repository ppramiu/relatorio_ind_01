...
O código \ref{cod:example_1_1_leveque} ilustra uma simples implementação serial de uma equação de diferenças avançadas, atrasadas e centradas, denotadas na saída do console respectivamente por, D+, D- e D0.
